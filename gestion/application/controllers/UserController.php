...
class UserController extends BaseController
{
			...
			if($data['username'] != null){
				...
				if($result->isValid()) {
					try{
						...
						{
							$tienda = $this->model->getTienda($user['idDeposito']);
							$user['tienda'] = $tienda;
	...
	public function createForm($tableid,$idValue,$fk,$fkvalue)
	{
		...
		else if ($tableid == 'idDeposito')
		{
			require_once(APPLICATION_PATH . '/forms/deposito.php');
			return new Form_Deposito();			
		}
	}
   ...
   public function edituserAction()
	...
	public function deleteuserAction()
    {
 	...
 	public function editdepositoAction()
    {
    	$this->save('idDeposito','edit','indexstocklocation');
    }
    
    public function adddepositoAction()
    {
    	$this->save('idDeposito','add','indexstocklocation');
    }
    
	public function deletedepositoAction()
    {
    	$this->delete('idDeposito','indexstocklocation');
    }
  
	
	public function indexstocklocationAction()
	{
		$this->titleView = "Gestion Stock Depositos";
		$this->view->depositos = $this->model->queryAll('TblStockDeposito');
	}
}
